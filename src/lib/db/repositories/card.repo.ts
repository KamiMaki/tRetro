...
interface CardRow {
  ...
  // is_parked column still exists in the schema for backward compat but is
  // no longer surfaced; the "park" UX moves the card to the deep-dive section
  // via CARD_MOVE instead.
  created_at: string;
  updated_at: string;
}
